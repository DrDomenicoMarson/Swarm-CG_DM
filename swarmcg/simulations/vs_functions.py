...
def vs2_func_1(state: SwarmCGState, traj, vs_def_beads_ids, vs_params):
...
def vs3_func_1(state: SwarmCGState, traj, vs_def_beads_ids, vs_params):
...
def vs3_func_2(state: SwarmCGState, traj, vs_def_beads_ids, vs_params):
    """Function for virtual_sites3.
...
def vs3_func_3(state: SwarmCGState, traj, vs_def_beads_ids, vs_params):
    """Function for virtual_sites3.
...
def vs3_func_4(state: SwarmCGState, traj, vs_def_beads_ids, vs_params):
    """Function for virtual_sites3.
...
def vs4_func_2(state: SwarmCGState, traj, vs_def_beads_ids, vs_params):
...
def vsn_func_1(state: SwarmCGState, traj, vs_def_beads_ids):
